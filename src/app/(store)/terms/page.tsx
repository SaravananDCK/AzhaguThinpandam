...
export default function TermsPage() {
  return (
    <PolicyLayout title="Terms &amp; Conditions" updated="21 July 2026">
      <p>
      ...
      <p>
        ...
        <a href="https://azhaguthinpandam.com">https://azhaguthinpandam.com</a> (&lsquo;Website&rsquo;),
      ...
      <p>
        ...
        conditions (&ldquo;Terms of Use&rdquo;) as applicable to the Platform including the
        applicable policies which are incorporated herein by way of reference. If You transact on the
        Platform, You shall be subject to the policies that are applicable to the Platform for such
        ...
        with Platform Owner. These Terms of Use relate to your use of our website, goods (as
        applicable) or services (as applicable) (collectively, &lsquo;Services&rsquo;). Any terms and
        conditions proposed by You which are in addition to or which conflict with these Terms of Use
        are expressly rejected by the Platform Owner and shall be of no force or effect. These Terms
        of Use can be modified at any time without assigning any reason. It is your responsibility to
        periodically review these Terms of Use to stay informed of updates.
      </p>
      <p>
        For the purpose of these Terms of Use, wherever the context so requires &lsquo;you&rsquo;,
        &lsquo;your&rsquo; or &lsquo;user&rsquo; shall mean any natural or legal person who has agreed
      ...
      <ul>
        ...
        <li>
          ...
          or demand, or actions including reasonable attorney&rsquo;s fees, made by any third party or
        ...
        <li>
          ...
          exclusive jurisdiction of the courts in Tuticorin and Tamil Nadu.
        </li>
        <li>
